...
func (m *myBackend) addGuideLineRoutes() {
	...
	exapserg.Handle("GET", "/system", m.generalHandle("lyear_config_system.html"))
	exapserg.Handle("GET", "/upload", m.generalHandle("lyear_config_upload.html"))
	...
	exapserg.Handle("GET", "/pf",    m.generalHandle("lyear_pages_profile.html"))
	exapserg.Handle("GET", "/pwd",    m.generalHandle("lyear_pages_edit_pwd.html"))
